            ...
            <div className="row">
                ...
                <div className="col-1">
                    <div className="btn-group">
                        <button type="button" className="btn  btn-large dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
            ...
            <div className="row">
                ...
                <div className="col-10 d-flex">
                    ...
                    <div class="input-group mb-3">
                        <input value={comment} type="text" class="form-control" placeholder="Share your comment.." onChange={(e) => setComment(e.target.value)} />
